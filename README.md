...
Copy [`statusline.sh`](https://github.com/martiner/claude-statusline/raw/refs/heads/master/statusline.sh) to `~/.claude/statusline.sh`. Simpler, but updates mean re-copying the file by hand.
